<template>
  <div class="ds-table">
    <table width="100%" rules="rows" frame="hsides" cellpadding="10px" border="0">
      <thead>
        <tr>
          <th v-for="i in columns" :key="i.dataIndex" :align="i.align ? i.align : 'left'" @click="handleSort(i)"
            ...
            <svg t="1653643754748" class="icon1" viewBox="0 0 1024 1024" version="1.1"
              xmlns="http://www.w3.org/2000/svg" p-id="2147" width="12" height="12" v-if="i.sort && sortable">
              <path
            ...
            <svg t="1653643914874" class="icon2" viewBox="0 0 1024 1024" version="1.1"
              xmlns="http://www.w3.org/2000/svg" p-id="3039" width="12" height="12" v-if="i.sort && sortable">
              <path
